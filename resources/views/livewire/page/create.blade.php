        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-2 bg-white rounded-md p-8 shadow">
                ...
                <div class="mt-6">
                    ...
                    <input type="file" id="cover" wire:model="cover" accept=".webp,.png,.jpg,.jpeg" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-100 file:text-indigo-700 hover:file:bg-indigo-200 mt-1 outline-none border-none">
                    <x-jet-input-error for="cover" class="mt-1"/>
                </div>
                <div class="mt-6">
                    <x-jet-label for="document_en_url" value="PDF Brochure - English"/>
                    <input type="file" id="document_en_url" wire:model="document_en_url" accept=".pdf" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-100 file:text-indigo-700 hover:file:bg-indigo-200 mt-1 outline-none border-none">
                    <x-jet-input-error for="document_en_url" class="mt-1"/>
                </div>
                <div class="mt-6">
                    <x-jet-label for="document_es_url" value="PDF Brochure - Spanish"/>
                    <input type="file" id="document_es_url" wire:model="document_es_url" accept=".pdf" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-100 file:text-indigo-700 hover:file:bg-indigo-200 mt-1 outline-none border-none">
